...
export default function GameIsOver({roundsNumber, userNumber, onStartNewGame}){
    ...
    <ScrollView style={styles.screen}> 
        <View style={styles.rootContainer}>
            ...
            <PrimaryButton onPrimaryButtonPress={onStartNewGame}>Start New Game</PrimaryButton>
        </View>
    </ScrollView>)
...
const styles = StyleSheet.create({
    ...
    //using Dimensions API to account for different screen sizes
    imageContainer:{
